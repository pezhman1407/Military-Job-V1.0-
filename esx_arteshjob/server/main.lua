...
RegisterServerEvent('esx_artesh_job:handcuff')
AddEventHandler('esx_artesh_job:handcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'artesh' then
		TriggerClientEvent('esx_artesh_job:handcuff', target)
	else
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'artesh' then
			Citizen.Wait(5000)
			TriggerClientEvent('esx_artesh_job:updateBlip', -1)
		end
	end	
end)

RegisterServerEvent('esx_artesh_job:spawned')
AddEventHandler('esx_artesh_job:spawned', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_artesh_job:forceBlip')
AddEventHandler('esx_artesh_job:forceBlip', function()
	TriggerClientEvent('esx_artesh_job:updateBlip', -1)
end)
...
RegisterServerEvent('esx_artesh_job:message')
AddEventHandler('esx_artesh_job:message', function(target, msg)
